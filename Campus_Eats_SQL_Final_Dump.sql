...
CREATE TABLE `driver_rating` (
  ...
  KEY `fk_driver_rating_driver1_idx` (`driver_id`),
  KEY `fk_driver_rating_order1_idx` (`order_id`),
  CONSTRAINT `fk_driver_rating_driver1` FOREIGN KEY (`driver_id`) REFERENCES `driver` (`driver_id`),
  CONSTRAINT `fk_driver_rating_order1` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`)
...
INSERT INTO `driver_rating` VALUES (1,5,'viverra. Maecenas iaculis aliquet diam.',4,5),(2,4,'augue, eu tempor erat neque',4,89),(3,4,'dolor, nonummy ac, feugiat non,',4,41),(4,4,'ultrices a, auctor non, feugiat',4,14),(5,5,'mi lorem, vehicula et, rutrum',5,85),(6,4,'iaculis quis, pede. Praesent eu',7,50),(7,3,'Phasellus dolor elit, pellentesque a,',1,89),(8,5,'odio sagittis semper. Nam tempor',5,1),(9,3,'Phasellus vitae mauris sit amet',7,99),(10,2,'pharetra, felis eget varius ultrices,',3,58),(11,2,'euismod est arcu ac orci.',7,80),(12,5,'nisi dictum augue malesuada malesuada.',5,7),(13,3,'ligula. Nullam enim. Sed nulla',8,12),(14,3,'ligula elit, pretium et, rutrum',3,95),(15,4,'orci. Ut sagittis lobortis mauris.',8,4),(16,1,'Donec nibh enim, gravida sit',8,90),(17,3,'Sed eu eros. Nam consequat',2,45),(18,2,'consequat nec, mollis vitae, posuere',1,17),(19,5,'vel nisl. Quisque fringilla euismod',8,20),(20,2,'consectetuer mauris id sapien. Cras',8,51),(21,1,'neque pellentesque massa lobortis ultrices.',8,32),(22,4,'magnis dis parturient montes, nascetur',3,34),(23,5,'quis arcu vel quam dignissim',3,56),(24,1,'egestas, urna justo faucibus lectus,',1,83),(25,3,'dignissim lacus. Aliquam rutrum lorem',6,87),(26,2,'nonummy. Fusce fermentum fermentum arcu.',7,76),(27,2,'suscipit nonummy. Fusce fermentum fermentum',3,99),(28,1,'rhoncus id, mollis nec, cursus',3,92),(29,3,'commodo ipsum. Suspendisse non leo.',1,97),(30,3,'gravida. Praesent eu nulla at',1,29),(31,5,'lobortis ultrices. Vivamus rhoncus. Donec',8,93),(32,4,'nibh dolor, nonummy ac, feugiat',4,80),(33,1,'rutrum magna. Cras convallis convallis',6,77),(34,2,'massa. Integer vitae nibh. Donec',4,16),(35,5,'turpis nec mauris blandit mattis.',2,98),(36,5,'amet metus. Aliquam erat volutpat.',3,60),(37,2,'per inceptos hymenaeos. Mauris ut',7,5),(38,5,'bibendum fermentum metus. Aenean sed',8,39),(39,3,'massa. Integer vitae nibh. Donec',1,38),(40,3,'lacus pede sagittis augue, eu',6,54),(41,5,'erat, in consectetuer ipsum nunc',1,71),(42,1,'netus et malesuada fames ac',2,90),(43,3,'vulputate, lacus. Cras interdum. Nunc',4,7),(44,1,'amet, consectetuer adipiscing elit. Curabitur',5,48),(45,1,'libero et tristique pellentesque, tellus',5,40),(46,1,'sagittis augue, eu tempor erat',7,67),(47,1,'lacus. Aliquam rutrum lorem ac',6,22),(48,2,'diam vel arcu. Curabitur ut',6,90),(49,5,'semper erat, in consectetuer ipsum',8,31),(50,4,'Donec sollicitudin adipiscing ligula. Aenean',7,70),(51,4,'risus. Nulla eget metus eu',5,60),(52,4,'Aenean eget magna. Suspendisse tristique',7,42),(53,2,'orci, consectetuer euismod est arcu',6,58),(54,5,'ligula. Nullam feugiat placerat velit.',6,30),(55,3,'egestas ligula. Nullam feugiat placerat',1,9),(56,2,'Mauris nulla. Integer urna. Vivamus',4,95),(57,3,'mus. Donec dignissim magna a',7,20),(58,4,'neque. In ornare sagittis felis.',5,31),(59,2,'porttitor eros nec tellus. Nunc',2,64),(60,1,'ornare placerat, orci lacus vestibulum',4,73),(61,1,'nulla. Donec non justo. Proin',6,13),(62,5,'Aliquam vulputate ullamcorper magna. Sed',2,52),(63,4,'ut, sem. Nulla interdum. Curabitur',6,64),(64,3,'ultrices. Vivamus rhoncus. Donec est.',7,89),(65,2,'cursus, diam at pretium aliquet,',1,79),(66,3,'porttitor vulputate, posuere vulputate, lacus.',4,29),(67,3,'nunc sed pede. Cum sociis',4,57),(68,3,'tempor bibendum. Donec felis orci,',8,19),(69,3,'In faucibus. Morbi vehicula. Pellentesque',4,93),(70,4,'consequat nec, mollis vitae, posuere',7,100),(71,4,'Nunc sollicitudin commodo ipsum. Suspendisse',6,38),(72,3,'magna, malesuada vel, convallis in,',5,62),(73,4,'sit amet, dapibus id, blandit',2,21),(74,3,'ante. Nunc mauris sapien, cursus',2,4),(75,4,'cursus purus. Nullam scelerisque neque',5,1),(76,5,'sit amet, risus. Donec nibh',7,53),(77,5,'sociosqu ad litora torquent per',3,72),(78,2,'Donec nibh. Quisque nonummy ipsum',6,30),(79,2,'a sollicitudin orci sem eget',1,86),(80,2,'nunc, ullamcorper eu, euismod ac,',3,5),(81,2,'mollis nec, cursus a, enim.',6,55),(82,3,'pede. Nunc sed orci lobortis',2,84),(83,2,'ut, molestie in, tempus eu,',4,69),(84,1,'gravida sit amet, dapibus id,',4,80),(85,1,'ac turpis egestas. Fusce aliquet',6,9),(86,1,'enim. Curabitur massa. Vestibulum accumsan',3,8),(87,3,'Duis elementum, dui quis accumsan',5,68),(88,3,'neque. Morbi quis urna. Nunc',3,90),(89,5,'lacus. Cras interdum. Nunc sollicitudin',5,2),(90,3,'iaculis odio. Nam interdum enim',4,79),(91,5,'Nunc mauris sapien, cursus in,',6,71),(92,5,'Sed molestie. Sed id risus',8,68),(93,3,'placerat. Cras dictum ultricies ligula.',3,67),(94,2,'neque vitae semper egestas, urna',6,74),(95,2,'neque et nunc. Quisque ornare',3,94),(96,5,'Nulla tincidunt, neque vitae semper',7,82),(97,4,'orci. Donec nibh. Quisque nonummy',1,35),(98,4,'Sed auctor odio a purus.',1,75),(99,4,'facilisis. Suspendisse commodo tincidunt nibh.',8,66),(100,5,'penatibus et magnis dis parturient',7,81);
...
CREATE TABLE `restaurant_rating` (
  ...
  KEY `fk_restaurant_rating_restaurant1_idx` (`restaurant_id`),
  KEY `fk_restaurant_rating_order1_idx` (`order_id`),
  CONSTRAINT `fk_restaurant_rating_order1` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`),
  CONSTRAINT `fk_restaurant_rating_restaurant1` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`restaurant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `restaurant_rating` VALUES (1,2,'Proin non massa non ante bibendum ullamcorper. Duis cursus, diam',1,1),(2,1,'ac orci. Ut semper pretium neque. Morbi quis urna. Nunc',2,2),(3,2,'enim commodo hendrerit. Donec porttitor tellus non magna. Nam ligula',3,3),(4,2,'metus eu erat semper rutrum. Fusce dolor quam, elementum at,',4,4),(5,4,'et, euismod et, commodo at, libero. Morbi accumsan laoreet ipsum.',5,5),(6,5,'egestas. Aliquam nec enim. Nunc ut erat. Sed nunc est,',6,6),(7,5,'Sed dictum. Proin eget odio. Aliquam vulputate ullamcorper magna. Sed',7,7),(8,4,'in molestie tortor nibh sit amet orci. Ut sagittis lobortis',8,8),(9,4,'facilisis. Suspendisse commodo tincidunt nibh. Phasellus nulla. Integer vulputate, risus',9,9),(10,3,'et netus et malesuada fames ac turpis egestas. Fusce aliquet',10,10),(11,2,'a, arcu. Sed et libero. Proin mi. Aliquam gravida mauris',11,11),(12,5,'tellus. Suspendisse sed dolor. Fusce mi lorem, vehicula et, rutrum',12,12),(13,1,'eu augue porttitor interdum. Sed auctor odio a purus. Duis',13,13),(14,2,'arcu. Morbi sit amet massa. Quisque porttitor eros nec tellus.',14,14),(15,2,'vitae, erat. Vivamus nisi. Mauris nulla. Integer urna. Vivamus molestie',15,15),(16,1,'enim diam vel arcu. Curabitur ut odio vel est tempor',16,16),(17,3,'nisi. Aenean eget metus. In nec orci. Donec nibh. Quisque',17,17),(18,4,'arcu. Sed et libero. Proin mi. Aliquam gravida mauris ut',18,18),(19,3,'odio a purus. Duis elementum, dui quis accumsan convallis, ante',19,19),(20,1,'laoreet lectus quis massa. Mauris vestibulum, neque sed dictum eleifend,',20,20),(21,1,'enim. Suspendisse aliquet, sem ut cursus luctus, ipsum leo elementum',21,21),(22,1,'neque. Morbi quis urna. Nunc quis arcu vel quam dignissim',22,22),(23,4,'vitae, orci. Phasellus dapibus quam quis diam. Pellentesque habitant morbi',23,23),(24,1,'parturient montes, nascetur ridiculus mus. Proin vel nisl. Quisque fringilla',24,24),(25,5,'eget massa. Suspendisse eleifend. Cras sed leo. Cras vehicula aliquet',25,25),(26,5,'est tempor bibendum. Donec felis orci, adipiscing non, luctus sit',26,26),(27,4,'libero. Proin sed turpis nec mauris blandit mattis. Cras eget',27,27),(28,2,'egestas. Duis ac arcu. Nunc mauris. Morbi non sapien molestie',28,28),(29,2,'Fusce mollis. Duis sit amet diam eu dolor egestas rhoncus.',29,29),(30,4,'velit in aliquet lobortis, nisi nibh lacinia orci, consectetuer